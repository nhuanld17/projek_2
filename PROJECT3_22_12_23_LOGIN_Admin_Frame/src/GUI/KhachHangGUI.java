...
//    }
    ...
    public KhachHangGUI() {
        ...
        textField_name.setFont(new Font("Segoe UI", Font.BOLD, 18));
        ...
        textField_Age.setFont(new Font("Segoe UI", Font.BOLD, 18));
        ...
        textField_roomNumber.setFont(new Font("Segoe UI", Font.BOLD, 18));
        ...
        textField_dateOrder.setFont(new Font("Segoe UI", Font.BOLD, 18));
        ...
        table_KhachHang.setFont(new Font("Segoe UI", Font.BOLD, 16));
        ...
        btn_reload_1.addActionListener(actionListener);
